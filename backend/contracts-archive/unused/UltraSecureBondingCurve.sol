...
/**
 * @title UltraSecureBondingCurve
 * @dev Improved bonding curve with security features, no locks, and dev buy option
 */
contract UltraSecureBondingCurve is Ownable(msg.sender), ReentrancyGuard, Pausable {
    // Token configuration
    ...
    uint256 public constant CREATION_FEE = 0.001 ether; // Ultra-low fee
    ...
    uint256 public constant MAX_DEV_BUY = 1 ether; // Max 1 ETH dev buy
    ...
    /**
     * @dev Create a new token with optional dev buy
     * @param _devBuyAmount Amount in ETH for initial dev buy (0 to MAX_DEV_BUY)
     */
    ...
    /**
     * @dev Sell tokens - NO LOCK PERIOD
     */
    function sellTokens(
        address _token,
